...
export default function Simbolos() {
    return(
        <div className='simbolos'>
            ...
            <h3 className='simbolos__subtitulo'>Bandera de la IE Gabriel Echavarría</h3>
            ...
            <h3 className='simbolos__subtitulo simbolos__subtitulo--aling'>Escudo Institucional</h3>
