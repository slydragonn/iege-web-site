    ...
    return (
        ...
        <div className='institucion__articulo'>
            <section className='institucion__info'>
                <h3><Link to='/institucional/filosofia/filosofia'>Filosofía Institucional</Link></h3>
        ...
        <div className='institucion__articulo'>
            <img src={principios} all='principios'/>
            <section className='institucion__info'>
                <h3><Link to='/institucional/filosofia/filosofia'>Principios Institucional</Link></h3>
        ...
        <div className='institucion__articulo'>
            <section className='institucion__info'>
                <h3><Link to='/institucional/filosofia/filosofia'>Valores Institucionales</Link></h3>
